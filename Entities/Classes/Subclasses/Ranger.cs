...
namespace Classes
{
    internal class Ranger : Arqueiro
    {
        ...
        public override void AdicionarHabilidades()
        {
            ...
            habilidade = new Habilidade("Melhor Amigo do Ranger", 15, 2, descricao, EfeitosDeHabilidades.MelhorAmigoDoRanger);
            Habilidades.Add(habilidade);

            descricao = "O Ranger atira 3 flechas rapidamente, seu Lobo morde o alvo três vezes";
            habilidade = new Habilidade("Pega!", 20, 2, descricao, EfeitosDeHabilidades.Pega);
            Habilidades.Add(habilidade);
        }
