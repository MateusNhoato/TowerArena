...
namespace Classes
{
    internal class Ladino : Ladrao
    {
        ...
        public override void AdicionarHabilidades()
        {
            ...
            Habilidade habilidade = new Habilidade("Estreia do Astro", 8, 10, descricao, EfeitosDeHabilidades.EstreiaDoAstro);
            ...
            habilidade = new Habilidade("Rasteira", 15, 4, descricao, EfeitosDeHabilidades.Rasteira);
            Habilidades.Add(habilidade);

            descricao = "O Ladino assalta de 2 a 3 poções de seu oponente e as bebe.\n          Atenção: o oponente pode ou não ter poções.";
            habilidade = new Habilidade("Pilhagem Conturbada", 15, 2, descricao, EfeitosDeHabilidades.PilhagemConturbada);
            Habilidades.Add(habilidade);
            ...
            habilidade = new Habilidade("Golpe Estatístico", 30, 1, descricao, EfeitosDeHabilidades.GolpeEstatistico);
            Habilidades.Add(habilidade);
        }
