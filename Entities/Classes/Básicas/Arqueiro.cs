...
namespace Classes
{
    internal class Arqueiro : Classe
    {
        ...
        public override void AdicionarHabilidades()
        {
            ...
            Habilidade habilidade = new Habilidade("Tiro Certeiro", 3, 10, descricao, EfeitosDeHabilidades.Ataque2x, TipoDeHabilidade.Ataque);
            Habilidades.Add(habilidade);

            descricao = "O Arqueiro se prepara durante uma rodada, aumentando seu poder pelo resto do combate.";
            habilidade = new Habilidade("Mente Afiada", 3, 4, descricao, EfeitosDeHabilidades.BuffAgilidade5, TipoDeHabilidade.Buff);
            Habilidades.Add(habilidade);

            descricao = "Uma flechada tão rápida que o oponente só  consegue desviar com sua iniciativa.";
            habilidade = new Habilidade("Tiro Preciso", 5, 3, descricao, EfeitosDeHabilidades.TiroPreciso, TipoDeHabilidade.Ataque);
            Habilidades.Add(habilidade);

            descricao = "Uma devastadora sucessão de flechas.";
            habilidade = new Habilidade("Saraivada de Flechas", 9, 3, descricao, EfeitosDeHabilidades.Ataque2EMeioX, TipoDeHabilidade.Ataque);
            Habilidades.Add(habilidade);
        }
