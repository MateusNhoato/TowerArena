...
namespace Classes
{
    internal class Ladrao : Classe
    {
        ...
        public override void AdicionarHabilidades()
        {
            ...
            Habilidade habilidade = new Habilidade("Golpe Visceral", 3, 5, descricao, EfeitosDeHabilidades.Ataque2x, TipoDeHabilidade.Ataque);
            ...
            habilidade = new Habilidade("Fuga", 9, 1, descricao, EfeitosDeHabilidades.Fuga, TipoDeHabilidade.Debuff);
            Habilidades.Add(habilidade);
        }
